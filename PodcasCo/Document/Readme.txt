...
【バージョン履歴】
Version 0.9
・番組のリストを日付順で並び替えられるようにした

Version 0.8
・メイン画面にステータスバーを追加。番組の取得状況をリアルタイムで表示するよう
　にした。
・放送局に追加と削除から放送局の順番を設定できるようにした
・起動時に自動でダウンロードの設定が正しくできなかったのを修正
・日付の解析失敗時に、コンテンツを最新と判断していたのを最新と判断しないように
　した（最新と判断することで自動ダウンロード時にそのコンテンツをダウンロードし
　てしまっていたため）
・アイコンをつけた。Designed by モケさん http://atmosphere00.blog109.fc2.com/

Version 0.7
・起動時に自動でダウンロード・削除する機能の追加
・同こんのFileDialogを1.16に変更

Version 0.6
・同こんのFileDialogを1.14に変更
・リジュームに対応した
・[メニュー]->[終了]で終了したときに、設定が保存されていなかったのを修正
・10MB以上のファイルをクリップする場合に、クリップフォームのプログレスバーが
　10MB近辺で動かなくなっていたのを修正
・クリップしたファイルが削除できなかった場合に落ちていたのを修正
・PodcastのRSSで1つの番組に複数の音声ファイルがある場合に対応した
・PodcastのRSSにenclosureタグが無い番組があった場合に落ちていたのを修正
・リジュームすべきファイルがリジュームせずに最初からダウンロードしていた場合が
　あったのをを修正
・すでにあるファイルをダウンロードしようとすると落ちていたのを修正
・ダウンロードしたPodcastのリストを書き出す処理が落ちることがあったのを修正
